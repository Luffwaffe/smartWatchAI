...
esp_err_t bsp_audio_init(const i2s_std_config_t *i2s_config)
{
    ...
    /* Use I2S port 0 by default on ESP32-C6; some configs set BSP I2S num to 1 which may be invalid */
...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    int buffer_size = cfg->buffer_size ? cfg->buffer_size : BSP_LCD_H_RES * LVGL_BUFFER_HEIGHT;
